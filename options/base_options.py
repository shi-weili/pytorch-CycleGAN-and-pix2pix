...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | simple_grid]')
        parser.add_argument('--model', type=str, default='cycle_gan',
                            help='chooses which model to use. cycle_gan, pix2pix, test')
        parser.add_argument('--which_direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--nThreads', default=4, type=int, help='# threads for loading data')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        parser.add_argument('--normG', type=str, default='instance', help='instance | batch | batch_renorm | batch_mod | none')
        parser.add_argument('--normD', type=str, default='instance', help='instance | batch | batch_renorm | batch_mod | none')
        ...
        # Terra Mars:
        parser.add_argument('--target', type=str, default='bm_land_ocean', help='Which Blue Marble version to use [bm | bm_enhanced | bm_land_ocean | bm_land_ocean_ice | night | clouds]')
