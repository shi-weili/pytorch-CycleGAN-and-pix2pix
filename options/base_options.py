...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--normG', type=str, default='instance', help='instance | batch | batch_mod | switchable | none')
        parser.add_argument('--normD', type=str, default='instance', help='instance | batch | batch_mod | switchable | none')
